...
import { ModMetadata } from '../types/shapez';
...
class MetaModFlipperBuilding extends shapez.ModMetaBuilding {
	...
	getAdditionalStatistics(root: GameRoot, variant: string): [string, string][] {
...
////////////////////////////////////////////////////////////////////////
import flipperPng from './resources/flipper.png';

const RESOURCES = {
	"flipper.png": base64ToPng(flipperPng),
};
