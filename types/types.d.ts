...
declare module "shapez/game/components/item_processor" {
	export * from 'fix/shapez/game/components/item_processor';
...
declare module "shapez/game/systems/item_processor" {
	...
	// };
	export { MOD_ITEM_PROCESSOR_HANDLERS } from 'fix/shapez/game/systems/item_processor'
	/**
...
declare module "shapez/mods/mod_interface" {
	...
	export class ModInterface {
		...
		addVariantToExistingBuilding(
			// FIXME
			metaClass: new (id: string) => MetaBuilding,
			variant: string,
			payload: {
...
declare module "shapez/mods/modloader" {
	import { ModMetadata } from 'fix/shapez/mods/modloader';
	export * from 'fix/shapez/mods/modloader';
	/**
	 * @typedef {{
	 *   name: string;
	 *   version: string;
	...
	// 	doesNotAffectSavegame?: boolean;
	// };
	export { ModMetadata } from "fix/shapez/mods/modloader";
	import { Application } from "shapez/application";
...
declare module "shapez/game/hub_goals" {
	export * from 'fix/shapez/game/hub_goals';
...
declare module "shapez/mods/mod_signals" {
	export { MOD_SIGNALS } from 'fix/shapez/mods/mod_signals';
}
